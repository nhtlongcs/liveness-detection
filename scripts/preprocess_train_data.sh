...
python preprocessing/generate_keyframes_labels.py $KEYFRAME_DIR $DATA_TRAIN_DIR/labels_video.csv $DATA_TRAIN_DIR/labels_keyframe.csv
python preprocessing/generate_keyframes_labels.py $KEYFRAME_DIR $DATA_TRAIN_DIR/labels_video_train.csv $DATA_TRAIN_DIR/labels_keyframe_train.csv
python preprocessing/generate_keyframes_labels.py $KEYFRAME_DIR $DATA_TRAIN_DIR/labels_video_test.csv $DATA_TRAIN_DIR/labels_keyframe_test.csv
