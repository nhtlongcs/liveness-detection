...
STANDARD_COLORS = [
    'DarkGrey', 'LawnGreen', 'Crimson', 'LightBlue', 'Gold', 'BlanchedAlmond',
    'Bisque', 'Aquamarine', 'BlueViolet', 'BurlyWood', 'CadetBlue',
    'AntiqueWhite', 'Azure', 'Chocolate', 'Coral', 'CornflowerBlue',
    ...
    'Khaki', 'Lavender', 'LavenderBlush', 'AliceBlue', 'LemonChiffon',
...
def from_colorname_to_bgr(color):
    ...
    result = (rgb_color.blue / 255.0, rgb_color.green / 255.0,
              rgb_color.red / 255.0)
    return result
...
def standard_to_bgr(list_color_name):
    standard = []
    for i in range(
            len(list_color_name)):  # -36 used to match the len(obj_list)
